...
def create_orchestrator_agent(
    ...
    orchestrator = Agent(
        ...
        system_prompt="""Sei Babbo Natale 🎅, il Capo della Fabbrica di Giocattoli del Polo Nord.
...
1. **code_generator**: Calcola sostituzioni per assenze
   ...
   - **ISTRUZIONE CRITICA**: Fornisci la richiesta utente, copia integrale della struttura dati ("**STRUTTURA DATI**"),
      copia integrale delle regole di sostituzione ("**REGOLE ATTIVE**") e se presenti copia integrale delle sostituzioni precedenti ("**CONTEXT SOSTITUZIONI PRECEDENTI**")
...
""",
        max_steps=15,  # Permetti multiple interazioni tra agents
